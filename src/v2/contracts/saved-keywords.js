...
export const SAVED_KEYWORDS_CONTRACT_VERSION = "saved-keywords-v0.3";
...
export function normalizeSavedKeywordBulkDelete(input) {
  if (!input || typeof input !== "object" || Array.isArray(input)) {
    fail("INVALID_BODY", "body", "Request body must be a JSON object.");
  }
  ...
  if (input.ids.length > 100) {
    fail("TOO_MANY_IDS", "ids", "No more than 100 saved keywords may be deleted at once.");
  }
